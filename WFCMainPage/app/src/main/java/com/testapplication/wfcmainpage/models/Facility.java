...
public class Facility {
	...
	public String getmOntwerper() {
		return mOntwerper;
	}

	public void setmOntwerper(String mOntwerper) {
		this.mOntwerper = mOntwerper;
	}

	public String getmDiversen() {
		return mDiversen;
	}

	public void setmDiversen(String mDiversen) {
		this.mDiversen = mDiversen;
	}

	public String getmQuickResponse() {
		return mQuickResponse;
	}

	public void setmQuickResponse(String mQuickResponse) {
		this.mQuickResponse = mQuickResponse;
	}

	public String getmCollectie() {
		return mCollectie;
	}

	public void setmCollectie(String mCollectie) {
		this.mCollectie = mCollectie;
	}

	public String getmOpAfspraak() {
		return mOpAfspraak;
	}

	public void setmOpAfspraak(String mOpAfspraak) {
